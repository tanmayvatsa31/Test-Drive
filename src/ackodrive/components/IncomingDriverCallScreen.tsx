...
export function IncomingDriverCallScreen({
  ...
  const handleReject = () => void customerRejectDriverCall(setState);
  const handlePick = () => void customerPickDriverCall(setState);
  ...
  return (
    <div className="ad-incoming-call-page">
      ...
      <div className="ad-incoming-call-body">
        <p className="ad-incoming-call-name">{driver.name}</p>
      ...
      <footer className="ad-incoming-call-controls">
        ...
        <div className="ad-incoming-call-primary">
          <button
            type="button"
            className="ad-incoming-call-pick-btn"
            onClick={handlePick}
            aria-label="Pick call"
          >
        ...
        <button type="button" className="ad-incoming-call-reject" onClick={handleReject}>
          Reject call
        </button>
      </footer>
    </div>
